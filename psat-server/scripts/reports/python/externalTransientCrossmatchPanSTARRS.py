...
Usage:
  %s <configfile> [<candidate>...] [--list=<listid>] [--searchRadius=<radius>] [--update] [--date=<date>] [--updateSNType] [--tnsOnly] [--fileoffiles]
  %s (-h | --help)
  %s --version
...
Options:
  ...
  Example:
    ...
    %s ../../../../../ps13pi/config/config.yaml /tmp/listofcandidates.txt --update --updateSNType --tnsOnly --fileoffiles
"""
import sys
