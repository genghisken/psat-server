...
# Detectability Server constants
detRequestPrefix = "qub_det_request"

# Postage Stamp Server constants
requestPrefix = "qub_ps_request"
postageStampServerURL = 'http://pstamp.ipp.ifa.hawaii.edu/upload.php'
username = 'ps1sc'
password = 'skysurveys'

#dataStoreURL = 'http://datastore.ipp.ifa.hawaii.edu/pstampresults/'
# 2015-04-27 KWS Change of stamp results location
dataStoreURL = 'http://datastore.ipp.ifa.hawaii.edu/qub-pstamp-results/'
...
def downloadPostageStampImage(conn, requestName, fitsRow, dataStoreFileInfo, PSSImageRootLocation):
...
def downloadFinderCMF(conn, requestName, fitsRow, dataStoreFileInfo, PSSImageRootLocation):
...
# 2014-03-08 KWS Added a new method to download Finder images
def downloadFinderImage(conn, requestName, fitsRow, dataStoreFileInfo, PSSImageRootLocation, offsetStarSearchRadius = 120.0, offsetStarMagThreshold = 15.0):
   """downloadFinderImage.
...
# 2015-03-18 KWS Override finder filter (e.g. with r-band).
def downloadFinderImage2(conn, requestName, fitsRow, dataStoreFileInfo, PSSImageRootLocation, offsetStarSearchRadius = 120.0, offsetStarMagThreshold = 15.0, offsetStarFilter = None):
...
def getDataStoreIndex(requestName, urlBase = dataStoreURL):
   """getDataStoreIndex.
   ...
   Args:
       ...
       urlBase:
   """
   url = urlBase + requestName + '/index.txt'
...
def sendPSRequest(filename, requestName):
   """sendPSRequest.
